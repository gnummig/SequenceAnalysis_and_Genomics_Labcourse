...
rm $1".RAxML_result_ids"
nw_labels $1".RAxML_result" > $1".RAxML_result_ids"
# rename the labels
rm  $1".RAxML.TAXA_TABLE_clean_sorted.txt"
./Id2taxa.sh $1".RAxML_result_ids" $1".TAXA_TABLE_clean.txt" $1".RAxML.TAXA_TABLE_clean_sorted.txt"
#put the new labels to the tree
rm $1".RAxML_result.sorted.tree"
